...
> **Note**: All non-structure setup files (AMBER input scripts, tleap/VMD scripts) are organized inside [WT_simulation_templates](./WT_simulation_templates/). The [NUC_models](./NUC_models/) directory exclusively stores initial PDB/coordinate files for all simulated systems.
