...
| `WT_simulation_templates/`| Wild-type (WT) reference templates for simulation setup, job submission, and analysis preprocessing. Copy and modify these files when setting up mutant or variant systems. |
