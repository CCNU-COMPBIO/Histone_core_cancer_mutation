...
| `Energetically_important_sites_analysis` | Identification and distribution analysis of energetically important residues |
| `Histone_mutation_analysis` | Analysis of histone mutations in core regions, including mutation frequency and charge changes |
| `Jaccard_similarity_analysis` | Jaccard similarity analysis for residue sets and sub-clusters |
...
| `hbond_analysis` | Hydrogen bond analysis |
